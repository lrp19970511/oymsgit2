<template>
  <div id="goodType">
    ...
    >
      ...
      <el-table-column prop="parentName" label="商品父类型" width="200px"></el-table-column>
      <el-table-column prop="typeName" label="商品子类型" width="200px"></el-table-column>
    ...
    getRowAndColumn(arr) {
      ...
      for (var i = 0; i < arr.length; i++) {
        if (i === 0) {
          ...
          //判断当前元素与上个元素是否相同
          if (arr[i].parentName == arr[i - 1].parentName) {
